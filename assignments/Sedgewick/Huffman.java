...
writeTrie(root);
System.err.println("writeTrie");

// print number of bytes in original uncompressed message
BinaryStdOut.write(input.length);
System.err.println("writing input length " + input.length);
...
System.err.println("buildTrie parent " + left.freq + " " + right.freq);
pq.insert(parent);
}
return pq.delMin();
}
...
st[x.ch] = s;
System.err.println("buildCode " + x.ch + " " + s);
}
}
